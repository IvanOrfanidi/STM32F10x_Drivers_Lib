  ...
  , public NonMovable<Clock>
{
  public:
	...
	// Enable GPIO clock
	void enable(const GPIO_TypeDef* const) const;

	// Disable GPIO clock
	void disable(const GPIO_TypeDef* const) const;

	// Enable SPI clock
	void enable(const SPI_TypeDef* const) const;

	// Disable SPI clock
	void disable(const SPI_TypeDef* const) const;

	void enable(const I2C_TypeDef* const) const;

	void disable(const I2C_TypeDef* const) const;

	void reset(const SPI_TypeDef* const) const;

	void reset(const I2C_TypeDef* const) const;
