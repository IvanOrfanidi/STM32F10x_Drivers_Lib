...
#include <inc/utils/virtual_port.h>
#include <inc/utils/ring_buffer.h>
  ...
  , public VirtualPort
{
  ...
  private:
	...
	static bool _isCreated[SpiInterface::MAX_COUNT_SPI];
};
